...
const RecalculateTotalPageNr =(function(){
    ...
    * DESC: This will be executed after
    *           - successfull page visits number update
    ...
    * DESC: Sumarize all none filtered ( not hidden ) page visit numbers
    ...
    */
    ...
    /**
    * CALCULATE
    * DESC: Sumarize all row numbers and return the total number
    * @since 1.0.0
    */
    ...
    // Reveale calculate methode so it can be reused in recalc-filtered-visits.js
    return {
