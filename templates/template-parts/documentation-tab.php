		...
		<div class="StrCPVisits_accordion_menu" data-stracc-close-other-options="true">
				...
				<div class="StrCPVisits_accordion_panel">
						<ul>
								...
								<li><?php esc_html_e('It is not going to crowd your database with tons of metric data and  "eat" database memory.', "page-visits-counter-lite"); ?></li>
				...
				<div class="StrCPVisits_accordion_panel">
						<p><?php esc_html_e("If you change the name of an existing page, post, product, archive, etc. then the old page will remain intact in the page visits report.", "page-visits-counter-lite"); ?><br>
							 <?php esc_html_e("After a new visit, the new page name will appear in the page visits report and the counter will start counting visits for the new page from the start.", "page-visits-counter-lite"); ?></p>
						<br>
				</div>
